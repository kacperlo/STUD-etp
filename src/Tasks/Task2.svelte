<script>
    ...
    $: poprawka = ((287.6155 + (4.8866 / (dlFali / 1000) ** 2 + 0.0680 / (dlFali / 1000) ** 4))*0.269578*P_ns/T_ns - (11.27*e_ns/T_ns)) - ((287.6155 + 4.8866 / (dlFali / 1000) ** 2 + 0.0680 / (dlFali / 1000) ** 4) * 0.269578 * pa / (temp_dry + 273.15) - (11.27 * ((6.1087 * (Math.E ** ((17.269 * temp_wet) / (237.30 + temp_wet)))) - (0.000662 * pa * (temp_dry - temp_wet))) / (temp_dry + 273.15)))
